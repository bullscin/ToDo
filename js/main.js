...
// Добавление блока список дел пуст из памяти
checkEmptyList();
...
function addTask(event) {
  ...
  // Сохраняем задачу в хранилище браузера local storage
  saveToLocalStorage();
...
function deleteTask(event) {
  ...
  // удаляем задачу через фильтрацию из массива
